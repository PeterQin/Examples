...
namespace Miscrosoft.ServiceModel.Samples
{
    ...
    public interface ICalculator
    {
        ...
        [OperationContract]
        ResponseFileInfo DownloadFileWithMsgContract(RequestFileInfo aFileInfo);    //File Transfer Sample
    ...
    [MessageContract]
    public class ResponseFileInfo   //File Transfer Sample
    {
    ...
    [MessageContract]
    public class RequestFileInfo    //File Transfer Sample
    {
        private string FFileName;
    ...
    public class CalculatorService : ICalculator
    {
        ...
        public ResponseFileInfo DownloadFileWithMsgContract(RequestFileInfo aFileInfo)  //File Transfer Sample
        {
    ...
    public class CusFileStream : FileStream //File Transfer Sample
    {
        long _count;
        long _lastPosition;        
